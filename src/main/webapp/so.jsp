...
<div class="movies">
    <c:forEach items="${list}" var="user">
        ...
        <%--<div class="title">--%>
        <%--<li><a target="_blank" href="http://www.changs1992.cn/wechat/web?code=" +${user.code}>${user.title}</a></li>--%>
        <%--</div>--%>
        <%--<div class="movInfo">--%>

        <%--<div class="left">--%>
        <%--<div class="thumb">--%>
        <%--<a target="_blank" href="http://www.changs1992.cn/wechat/web?code=" +${user.code}>--%>
        <%--<img alt=${user.code} class="orginSrc"--%>
        <%--data-url=${user.img1}--%>
        <%--src=${user.img1}>--%>
        <%--</a>--%>
        <%--</div>--%>
